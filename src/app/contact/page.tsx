  ...
  return (
    <div className="pt-32 pb-24 md:pt-40 md:pb-32 px-6 max-w-5xl mx-auto">
      ...
      <div className="text-center mb-14">
        ...
        <p className="text-sm text-[#A8A8AF] max-w-md mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2 space-y-5">
          <div className="rounded-3xl bg-[#141417] border border-white/[0.08] p-7">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-xs font-mono font-bold text-[#F4F4F0] mb-0.5">In-Game Location</div>
                  <div className="text-xs text-[#A8A8AF] leading-relaxed">{siteConfig.serverInfo.inGameLocation}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-xs font-mono font-bold text-[#F4F4F0] mb-0.5">IC Email</div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-4 rounded-3xl bg-gradient-to-r from-[#1C1C22] to-[#141417] border border-white/15 hover:border-[#CCFF00]/50 p-7 transition-all group"
          >
            ...
            <div className="flex-grow">
              <div className="text-sm font-bold text-[#F4F4F0] group-hover:text-white transition-colors">
                Discord — Fastest Response
              </div>
              <div className="text-xs text-[#A8A8AF] mt-0.5">
                Average response under 2 hours during LS business hours.
              </div>
            </div>
            <ArrowRight className="w-4 h-4 text-[#A8A8AF] group-hover:text-[#CCFF00] transition-colors group-hover:translate-x-1" />
          </a>
        </div>

        {/* Contact Form */}
        <div className="lg:col-span-3">
          <div className="rounded-3xl bg-[#141417] border border-white/[0.08] p-7 md:p-10">
            {submitted ? (
              <motion.div
              ...
              >
                ...
                <h3 className="text-xl font-display font-bold text-[#F4F4F0]">Message received</h3>
                <p className="text-sm text-[#A8A8AF] max-w-xs">
                  We&apos;ll reach back out via Discord within a few hours. In the meantime, you
                  can browse our portfolio or submit a design brief.
                </p>
                <Link
                  href="/request"
                  className="mt-2 px-6 py-3 rounded-full text-xs font-bold text-[#0B0B0D] bg-[#CCFF00] hover:bg-[#B8E600] transition-colors"
                >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-xs font-mono text-[#A8A8AF] mb-1.5 block uppercase tracking-wider">
                      Discord Handle <span className="text-[#6B6B72] lowercase">(optional)</span>
                    </label>
                    <input
                      {...register("discordTag")}
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mt-1">
                    ...
                    <span className="text-[11px] font-mono text-[#6B6B72]">{msgLen}/1000</span>
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-4 rounded-full text-sm font-bold text-[#0B0B0D] bg-[#CCFF00] hover:bg-[#B8E600] disabled:opacity-60 transition-all shadow-glow-lime flex items-center justify-center gap-2"
                >
                  {submitting ? (
