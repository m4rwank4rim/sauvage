      ...
      {item && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-4xl max-h-[90vh] bg-[#141417] border border-white/15 rounded-3xl md:rounded-4xl shadow-2xl overflow-hidden flex flex-col md:flex-row"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
            ...
            <div className="md:w-1/2 min-h-[260px] sm:min-h-[320px] md:min-h-[480px] bg-[#0B0B0D] border-b md:border-b-0 md:border-r border-white/[0.08] flex items-center justify-center relative overflow-hidden">
